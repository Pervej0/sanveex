      ...
      <div className="container">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-2.5 text-error px-4 py-2.5 rounded-lg transition-colors shadow-sm">
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[400px] overflow-y-auto">
                ...
                <div className="flex flex-col space-y-2 mt-4">
                  ...
                  <div className="mt-8 pt-6 border-t border-border">
                    <div className="flex items-center gap-3 bg-error/10 border border-error/20 text-error px-4 py-4 rounded-lg">
