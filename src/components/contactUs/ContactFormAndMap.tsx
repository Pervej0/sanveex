...
export default function ContactFormAndMap() {
  return (
    <section className="container py-14 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-10">
        {/* Google Map */}
        <div className="rounded-xl overflow-hidden shadow-md h-[450px] lg:h-[520px]">
          <iframe
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm h-[90px] focus:outline-none focus:ring-2 focus:ring-blue-500"
              ></textarea>
            </div>
